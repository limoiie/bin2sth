...
def store_binary(db, prog: Program):
    """
    After generate the program info by ida pro script, call this
    function to store the info into the database.
    """
    db.binaries.insert_one(prog.dict())
